...
class Estimator():
	...
	# Variables
		...
		# GAINS
		self.drive_gain = 4.0/100#4.0/100 # measured 4.0 meters/s when commanded full speed
	...
	def gpsCallback(self, msg):
		...
		if not self.gps_init:
			...
			self.estimate.base_latitude = 40.247651667
			self.estimate.base_longitude = -111.64733
	...
	def imuCallback(self, msg):
		...
		if (Ts > 0.5):
			...
			self.estimate.psi = -euler[2]- (11.0*np.pi/180.0)
